...
?><html>
<head>
<title>Test of CSS callToAction buttons</title>
...
<link href="<?php echo build_preset_url('css', 'buttons-action'); ?>" media="screen" rel="stylesheet" type="text/css" />
...
<body>
	<p>This page provides tests of the CSS '<strong>callToAction buttons</strong>' construction.</p>
	<p>Original work from Andrew Roberts (<a href="http://sixrevisions.com/css/create-a-css3-call-to-action-button/">http://sixrevisions.com/css/create-a-css3-call-to-action-button/</a>).</p>
	<hr />
...
<div id="linear">
  <a href="#action" class="btn">CLICK THIS BUTTON</a>
</div>
