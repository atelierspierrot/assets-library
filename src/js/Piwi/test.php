...
<script type="text/javascript" src="../document/document_load.js"></script>
...
// all Piwi dependencies
//addJavascript('../node/select.js');
$.load('applyCallback', '../callback/applyCallback.js');
$.load('each', '../array/each.js');
$.load('Select', '../node/select.js'); // => no error
