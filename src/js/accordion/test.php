...
<!-- Preset "accordion" -->
<script type="text/javascript" src="<?php echo build_preset_url('js', 'accordion'); ?>"></script>
<link href="<?php echo build_preset_url('css', 'accordion'); ?>" media="screen" rel="stylesheet" type="text/css" />
