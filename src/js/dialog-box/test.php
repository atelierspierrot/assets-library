...
<!-- Requirements : clone | extend | document load | form_serialize | draggable | node/classes | node/get_style_attribute | node/get_offset -->
<script type="text/javascript" src="../library.js.php?clone&extend&document[]=document_load&form_serialize&draggable&node[]=classes&node[]=get_style_attribute&node[]=get_offset&document[]=get_document_sizes&window[]=get_window_sizes"></script>
<link href="../library.css.php?clone&extend&document[]=document_load&form_serialize&ajax&draggable" media="screen" rel="stylesheet" type="text/css" />

<!-- Ajax Requirements : ajax | system/uniqid | array/in_array -->
<script type="text/javascript" src="../library.js.php?system=uniqid&array=in_array&ajax"></script>
