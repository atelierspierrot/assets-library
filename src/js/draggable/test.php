...
--><html>
<head>
<title>Test of Draggable javascript class</title>
...
<!-- Requirements : clone | extend | document load | node/classes | node/get_style_attribute | node/get_offset | document/get_document_sizes -->
<script type="text/javascript" src="../library.js.php?clone&extend&document[]=document_load&node[]=classes&node[]=get_style_attribute&node[]=get_offset&document[]=get_document_sizes"></script>
...
console.debug(Draggable.version);
...
<style type="text/css">
#block4 { width:600px; position: absolute; display: inline-block; background: #fff; /*border: 1px solid red;*/ }
</style>
</head>

<body>
	<p>This page provides tests of the javascript 'class' '<strong>Draggable</strong>'; information is written in console.</p>
