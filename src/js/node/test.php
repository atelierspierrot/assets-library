...
<!-- Preset "node" -->
<script type="text/javascript" src="<?php echo build_preset_url('js', 'node'); ?>"></script>
<link href="<?php echo build_preset_url('css', 'node'); ?>" media="screen" rel="stylesheet" type="text/css" />
