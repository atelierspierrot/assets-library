...
--><html>
<head>
<title>Test of Resizable javascript class</title>
...
<!-- Requirements : clone | extend | document load | node/classes | node/get_style_attribute -->
<script type="text/javascript" src="../library.js.php?clone&extend&document=document_load&node[]=classes&node[]=get_style_attribute"></script>

<!-- Resizable -->
<script type="text/javascript" src="resizable.js"></script>  
<link href="resizable.css" media="screen" rel="stylesheet" type="text/css" />

<script language="Javascript" type="text/javascript">

onDocumentLoad(function(){

    var elt = document.getElementById('block4');
    elt.resizable();

    var elt2 = document.getElementById('block5');
    elt2.resizable({
        resizer: document.getElementById('my-resizer')
    });
...
<style type="text/css">
#my-resizer    {
    background: #fff url(icon_resize.gif) no-repeat 99.5% 60%; height: 13px; margin: 0; margin-left: 1px; padding: 2px; width: 99%;
    display: block; position: absolute; bottom: 0; left: 0;
    border-top: 1px dotted #ccc; cursor: se-resize;
}
</style>
</head>

<body>
	<p>This page provides tests of the javascript 'class' '<strong>Resizable</strong>'; information is written in console.</p>


<h3>Maecenas libero lectus, eleifend congue</h3>

<div id="block4" style="width:600px; display: block; /*border: 1px solid red*/">
...
<div id="block5" style="width:600px; display: block;">
    <p><strong>With a custom handler</strong></p>
