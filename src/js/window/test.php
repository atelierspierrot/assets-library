...
?><html>
<head>
<title>Test of window javascript functions</title>
...
<body>
	<p>This page provides tests of the javascript function '<strong>windows</strong>'; information is written in console.</p>
	<hr />

	<ul>
		<li><a href="#" onclick="return popup_set('popup_content.php');">open popup</a></li>
		<li><a href="#" onclick="return opener_focus(NEWPOPUPWINDOW);">re-focus popup</a></li>
		<li><a href="#" onclick="return opener_focus(NEWPOPUPWINDOW, 'popup_content2.php');">re-focus popup & load new URL</a></li>
		<li><a href="#" onclick="return NEWPOPUPWINDOW.close();">close popup</a></li>
	</ul>
